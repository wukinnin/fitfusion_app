...
extension AchievementIdExtension on AchievementId {
  ...
  String get description {
    switch (this) {
      case AchievementId.firstBlood:
        return 'Complete your first session (win or lose).';
      case AchievementId.ironWill:
        return 'Complete 30 total sessions.';
      case AchievementId.bloodPumper:
        return 'Reach 300 lifetime reps.';
      case AchievementId.survivor:
        return 'Complete 100 total rounds.';
      case AchievementId.halfwayHero:
        return 'Reach 5 rounds in a single session.';
      case AchievementId.monsterHunter:
        return 'Win a full 10-round session.';
      case AchievementId.tripleCrown:
        return 'Win at least one session in all 3 workout types.';
      case AchievementId.speedDemon:
        return 'Achieve a best rep interval under 1.8 seconds.';
      case AchievementId.blindingSteel:
        return 'Win with an average rep interval under 2.3 sec.';
      case AchievementId.untouchable:
        return 'Win with 0 lives lost.';
      case AchievementId.lastStand:
        return 'Win with exactly 2 lives lost.';
    }
  }
}
