...
const String kSupabaseAnonKey = 'sb_publishable_RRnQl83nt607J6kh1pf_dQ_OUEHG_nc';
...
const double kSpeedDemonThreshold = 1.8; // #8  — best rep interval (seconds) must be below this
const double kBlindingSteelThreshold = 2.3; // #9 — avg rep interval (seconds) must be below this
